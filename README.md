...
| Check mage accuracy      | The plugin will only work as intended if your magic accuracy bonus is -64 or below, which guarantees a splash.           |
...
Tick all of the configuration boxes (check the table above for more info on them) and set up both the NPC death notification and the expiry notification as such:
